    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item active">
          <a class="nav-link active" href="userfront.php">Home
...
<?php if($_SESSION['loggedIn']&&$_SESSION[count]==1): ?>
<script type='text/javascript'>alert('Welcome <?php echo $_SESSION['user_name']; ?>')</script>
